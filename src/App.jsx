...
const allowDistrictComparisons = selectedCategory === 'cluster';

  const hasStateSelection = Boolean(selectedStateName);
  const hasDistrictSelection = Boolean(selectedDistrictName);
  const hideComparisonsForDbScanDistrict = selectedCategory === 'cluster' && hasDistrictSelection;
  const canShowComparisons = !isSchoolZone && (!hasDistrictSelection || allowDistrictComparisons) && !hideComparisonsForDbScanDistrict;
  ...
  useEffect(() => {
    if (hasDistrictSelection && activeBottomTab === TAB_COMPARISONS) {
      setActiveBottomTab(TAB_GLOBAL_SUMMARIES);
    }
  }, [hasDistrictSelection, activeBottomTab]);
            ...
            <div className="tabs-panel">
              <div className="map-tabs-section">
                ...
                <div className="map-tabs-content" role="tabpanel">
                  ...
                  {canShowComparisons && activeBottomTab === TAB_COMPARISONS && (
                    <ComparisonsPanel
                      selectedStateName={selectedStateName}
                      selectedDistrictName={selectedDistrictName}
                      selectedCategory={selectedCategory}
